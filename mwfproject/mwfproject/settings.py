"""
Django settings for mwfproject project.
...
SECRET_KEY = 'django-insecure-8xb_35ilq8=1c#hu0cbhq_t=yzpou-v)w^sxte%bk_0%i1*4pi'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mayondo-g443.onrender.com', 'localhost', '127.0.0.1', '*']
...
WSGI_APPLICATION = 'mwfproject.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Look for a 'static' folder at project root
]
